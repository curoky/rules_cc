...
def new_github_repo(name, remote, path = None, branch = "master"):
    ...
    path = "@com_curoky_rules_cc//:third_party/" + path + ".BUILD"
...
def load_all_repo():
    ...
    new_github_repo("com_github_facebook_fbthrift", "facebook/fbthrift", branch = "v2020.12.14.00")
    new_github_repo("com_github_facebook_folly", "facebook/folly", branch = "v2020.12.14.00")
    new_github_repo("com_github_facebook_proxygen", "facebook/proxygen", branch = "v2020.12.14.00")
    new_github_repo("com_github_facebook_wangle", "facebook/wangle", branch = "v2020.12.14.00")
    new_github_repo("com_github_facebook_zstd", "facebook/zstd")
    new_github_repo("com_github_facebookincubator_fizz", "facebookincubator/fizz", branch = "v2020.12.14.00")
    ...
    new_git_repository(
        ...
        branch = "master",
        build_file = "@com_curoky_rules_cc//:third_party/diff-match-patch/diff-match-patch.BUILD",
        patch_cmds = [
