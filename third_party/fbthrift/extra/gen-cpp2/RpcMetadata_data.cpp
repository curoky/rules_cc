...
constexpr const std::array<::apache::thrift::InterfaceKind, 3> TEnumDataStorage<::apache::thrift::InterfaceKind>::values;
constexpr const std::array<folly::StringPiece, 3> TEnumDataStorage<::apache::thrift::InterfaceKind>::names;
...
constexpr const std::size_t TEnumDataStorage<::apache::thrift::ServerPushMetadata::Type>::size;
constexpr const std::array<::apache::thrift::ServerPushMetadata::Type, 1> TEnumDataStorage<::apache::thrift::ServerPushMetadata::Type>::values;
constexpr const std::array<folly::StringPiece, 1> TEnumDataStorage<::apache::thrift::ServerPushMetadata::Type>::names;
...
constexpr const std::size_t TStructDataStorage<::apache::thrift::SetupResponse>::fields_size;
constexpr const std::array<folly::StringPiece, TStructDataStorage<::apache::thrift::SetupResponse>::fields_size> TStructDataStorage<::apache::thrift::SetupResponse>::fields_names;
constexpr const std::array<int16_t, TStructDataStorage<::apache::thrift::SetupResponse>::fields_size> TStructDataStorage<::apache::thrift::SetupResponse>::fields_ids;
constexpr const std::array<apache::thrift::protocol::TType, TStructDataStorage<::apache::thrift::SetupResponse>::fields_size> TStructDataStorage<::apache::thrift::SetupResponse>::fields_types;
constexpr const std::size_t TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_size;
constexpr const std::array<folly::StringPiece, TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_size> TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_names;
constexpr const std::array<int16_t, TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_size> TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_ids;
constexpr const std::array<apache::thrift::protocol::TType, TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_size> TStructDataStorage<::apache::thrift::ServerPushMetadata>::fields_types;
