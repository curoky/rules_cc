...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
RequestRpcMetadata::RequestRpcMetadata(apache::thrift::FragileConstructor,  ::apache::thrift::ProtocolId protocol__arg, ::std::string name__arg,  ::apache::thrift::RpcKind kind__arg, int32_t seqId__arg, int32_t clientTimeoutMs__arg, int32_t queueTimeoutMs__arg,  ::apache::thrift::RpcPriority priority__arg, ::std::map<::std::string, ::std::string> otherMetadata__arg, std::uint32_t crc32c__arg, ::std::string loadMetric__arg,  ::apache::thrift::CompressionAlgorithm compression__arg,  ::apache::thrift::CompressionConfig compressionConfig__arg, int64_t interactionId__arg,  ::apache::thrift::InteractionCreate interactionCreate__arg, ::std::string clientId__arg, ::std::string serviceTraceMeta__arg) :
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
RequestSetupMetadata::RequestSetupMetadata(apache::thrift::FragileConstructor, apache::thrift::MetadataOpaqueMap<::std::string, ::std::string> opaque__arg,  ::apache::thrift::InterfaceKind interfaceKind__arg, int32_t minVersion__arg, int32_t maxVersion__arg, int32_t dscpToReflect__arg, int32_t markToReflect__arg, ::std::string clientAgent__arg, ::std::string clientHostId__arg) :
    ...
    clientAgent(std::move(clientAgent__arg)),
    clientHostId(std::move(clientHostId__arg)) {
  __isset.opaque = true;
...
void RequestSetupMetadata::__clear() {
  ...
  dscpToReflect = 0;
  markToReflect = 0;
  clientAgent = apache::thrift::StringTraits< std::string>::fromStringLiteral("");
  clientHostId = apache::thrift::StringTraits< std::string>::fromStringLiteral("");
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  __isset = {};
THRIFT_IGNORE_ISSET_USE_WARNING_END
}
...
bool RequestSetupMetadata::operator==(const RequestSetupMetadata& rhs) const {
  ...
  if (lhs.clientAgent_ref() != rhs.clientAgent_ref()) {
    return false;
  }
  if (lhs.clientHostId_ref() != rhs.clientHostId_ref()) {
    return false;
  }
  return true;
}
...
void swap(RequestSetupMetadata& a, RequestSetupMetadata& b) {
  ...
  swap(a.clientAgent_ref().value_unchecked(), b.clientAgent_ref().value_unchecked());
  swap(a.clientHostId_ref().value_unchecked(), b.clientHostId_ref().value_unchecked());
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  swap(a.__isset, b.__isset);
THRIFT_IGNORE_ISSET_USE_WARNING_END
}
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
SetupResponse::SetupResponse(apache::thrift::FragileConstructor, int32_t version__arg) :
