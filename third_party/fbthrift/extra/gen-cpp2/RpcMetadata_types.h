...
#endif
#ifndef APACHE_THRIFT_ACCESSOR_clientAgent
#define APACHE_THRIFT_ACCESSOR_clientAgent
APACHE_THRIFT_DEFINE_ACCESSOR(clientAgent);
#endif
#ifndef APACHE_THRIFT_ACCESSOR_clientHostId
#define APACHE_THRIFT_ACCESSOR_clientHostId
APACHE_THRIFT_DEFINE_ACCESSOR(clientHostId);
#endif
...
template <> struct TEnumTraits<::apache::thrift::InterfaceKind> {
  ...
  static constexpr type max() { return type::MONITORING; }
};
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  ...
  // FragileConstructor for use in initialization lists only.
  [[deprecated("This constructor is deprecated")]]
  RequestRpcMetadata(apache::thrift::FragileConstructor,  ::apache::thrift::ProtocolId protocol__arg, ::std::string name__arg,  ::apache::thrift::RpcKind kind__arg, int32_t seqId__arg, int32_t clientTimeoutMs__arg, int32_t queueTimeoutMs__arg,  ::apache::thrift::RpcPriority priority__arg, ::std::map<::std::string, ::std::string> otherMetadata__arg, std::uint32_t crc32c__arg, ::std::string loadMetric__arg,  ::apache::thrift::CompressionAlgorithm compression__arg,  ::apache::thrift::CompressionConfig compressionConfig__arg, int64_t interactionId__arg,  ::apache::thrift::InteractionCreate interactionCreate__arg, ::std::string clientId__arg, ::std::string serviceTraceMeta__arg);
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  ...
  // FragileConstructor for use in initialization lists only.
  [[deprecated("This constructor is deprecated")]]
  RequestSetupMetadata(apache::thrift::FragileConstructor, apache::thrift::MetadataOpaqueMap<::std::string, ::std::string> opaque__arg,  ::apache::thrift::InterfaceKind interfaceKind__arg, int32_t minVersion__arg, int32_t maxVersion__arg, int32_t dscpToReflect__arg, int32_t markToReflect__arg, ::std::string clientAgent__arg, ::std::string clientHostId__arg);
...
THRIFT_IGNORE_ISSET_USE_WARNING_END
 ...
 private:
  ::std::string clientAgent;
 private:
  ::std::string clientHostId;
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<const T&> clientAgent_ref() const& {
    return {this->clientAgent, __isset.clientAgent};
  }

  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<const T&&> clientAgent_ref() const&& {
    return {std::move(this->clientAgent), __isset.clientAgent};
  }

  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<T&> clientAgent_ref() & {
    return {this->clientAgent, __isset.clientAgent};
  }
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<const T&> clientHostId_ref() const& {
    return {this->clientHostId, __isset.clientHostId};
  }

  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<const T&&> clientHostId_ref() const&& {
    return {std::move(this->clientHostId), __isset.clientHostId};
  }

  template <typename..., typename T = ::std::string>
  FOLLY_ERASE ::apache::thrift::optional_field_ref<T&> clientHostId_ref() & {
    return {this->clientHostId, __isset.clientHostId};
  }
...
THRIFT_IGNORE_ISSET_USE_WARNING_END
  ...
  const ::std::string* get_clientAgent() const& {
    return clientAgent_ref() ? std::addressof(clientAgent) : nullptr;
  }

  ::std::string* get_clientAgent() & {
    return clientAgent_ref() ? std::addressof(clientAgent) : nullptr;
  }
  ::std::string* get_clientAgent() && = delete;

  template <typename T_RequestSetupMetadata_clientAgent_struct_setter = ::std::string>
  ::std::string& set_clientAgent(T_RequestSetupMetadata_clientAgent_struct_setter&& clientAgent_) {
    clientAgent = std::forward<T_RequestSetupMetadata_clientAgent_struct_setter>(clientAgent_);
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    __isset.clientAgent = true;
THRIFT_IGNORE_ISSET_USE_WARNING_END
    return clientAgent;
  }

  const ::std::string* get_clientHostId() const& {
    return clientHostId_ref() ? std::addressof(clientHostId) : nullptr;
  }

  ::std::string* get_clientHostId() & {
    return clientHostId_ref() ? std::addressof(clientHostId) : nullptr;
  }
  ::std::string* get_clientHostId() && = delete;

  template <typename T_RequestSetupMetadata_clientHostId_struct_setter = ::std::string>
  ::std::string& set_clientHostId(T_RequestSetupMetadata_clientHostId_struct_setter&& clientHostId_) {
    clientHostId = std::forward<T_RequestSetupMetadata_clientHostId_struct_setter>(clientHostId_);
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    __isset.clientHostId = true;
THRIFT_IGNORE_ISSET_USE_WARNING_END
    return clientHostId;
  }
...
THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
  ...
  // FragileConstructor for use in initialization lists only.
  [[deprecated("This constructor is deprecated")]]
  SetupResponse(apache::thrift::FragileConstructor, int32_t version__arg);
...
THRIFT_IGNORE_ISSET_USE_WARNING_END
  ...
  const int32_t* get_version() const& {
