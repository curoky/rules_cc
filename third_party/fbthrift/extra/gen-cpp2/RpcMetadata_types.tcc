...
_readField_clientAgent:
  {
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::string, ::std::string>::readWithContext(*iprot, this->clientAgent, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.clientAgent = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
  }
...
_readField_clientHostId:
  {
    ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::string, ::std::string>::readWithContext(*iprot, this->clientHostId, _readState);
    THRIFT_IGNORE_ISSET_USE_WARNING_BEGIN
    this->__isset.clientHostId = true;
    THRIFT_IGNORE_ISSET_USE_WARNING_END
  }
...
uint32_t RequestSetupMetadata::serializedSize(Protocol_ const* prot_) const {
  ...
  if (this->clientAgent_ref().has_value()) {
    xfer += prot_->serializedFieldSize("clientAgent", apache::thrift::protocol::T_STRING, 7);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::string, ::std::string>::serializedSize<false>(*prot_, this->clientAgent);
  }
  if (this->clientHostId_ref().has_value()) {
    xfer += prot_->serializedFieldSize("clientHostId", apache::thrift::protocol::T_STRING, 8);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::string, ::std::string>::serializedSize<false>(*prot_, this->clientHostId);
  }
  xfer += prot_->serializedSizeStop();
  return xfer;
}
...
uint32_t RequestSetupMetadata::write(Protocol_* prot_) const {
  ...
  if (this->clientAgent_ref().has_value()) {
    xfer += prot_->writeFieldBegin("clientAgent", apache::thrift::protocol::T_STRING, 7);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::string, ::std::string>::write(*prot_, this->clientAgent);
    xfer += prot_->writeFieldEnd();
  }
  if (this->clientHostId_ref().has_value()) {
    xfer += prot_->writeFieldBegin("clientHostId", apache::thrift::protocol::T_STRING, 8);
    xfer += ::apache::thrift::detail::pm::protocol_methods< ::apache::thrift::type_class::string, ::std::string>::write(*prot_, this->clientHostId);
    xfer += prot_->writeFieldEnd();
  }
  xfer += prot_->writeFieldStop();
  xfer += prot_->writeStructEnd();
