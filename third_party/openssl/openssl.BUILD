...
BN_CONF_H = """#ifndef OSSL_CRYPTO_BN_CONF_H
...
DSO_CONF_H = """#ifndef OSSL_CRYPTO_DSO_CONF_H
...
PERLASM_GEN = """
CC=$(CC) perl $(location crypto/aes/asm/aesni-mb-x86_64.pl) elf $(location crypto/aes/aesni-mb-x86_64.s);
CC=$(CC) perl $(location crypto/aes/asm/aesni-sha1-x86_64.pl) elf $(location crypto/aes/aesni-sha1-x86_64.s);
CC=$(CC) perl $(location crypto/aes/asm/aesni-sha256-x86_64.pl) elf $(location crypto/aes/aesni-sha256-x86_64.s);
CC=$(CC) perl $(location crypto/aes/asm/aesni-x86_64.pl) elf $(location crypto/aes/aesni-x86_64.s);
CC=$(CC) perl $(location crypto/aes/asm/vpaes-x86_64.pl) elf $(location crypto/aes/vpaes-x86_64.s);
CC=$(CC) perl $(location crypto/bn/asm/rsaz-avx2.pl) elf $(location crypto/bn/rsaz-avx2.s);
CC=$(CC) perl $(location crypto/bn/asm/rsaz-x86_64.pl) elf $(location crypto/bn/rsaz-x86_64.s);
CC=$(CC) perl $(location crypto/bn/asm/x86_64-gf2m.pl) elf $(location crypto/bn/x86_64-gf2m.s);
CC=$(CC) perl $(location crypto/bn/asm/x86_64-mont.pl) elf $(location crypto/bn/x86_64-mont.s);
CC=$(CC) perl $(location crypto/bn/asm/x86_64-mont5.pl) elf $(location crypto/bn/x86_64-mont5.s);
CC=$(CC) perl $(location crypto/camellia/asm/cmll-x86_64.pl) elf $(location crypto/camellia/cmll-x86_64.s);
CC=$(CC) perl $(location crypto/chacha/asm/chacha-x86_64.pl) elf $(location crypto/chacha/chacha-x86_64.s);
CC=$(CC) perl $(location crypto/ec/asm/ecp_nistz256-x86_64.pl) elf $(location crypto/ec/ecp_nistz256-x86_64.s);
CC=$(CC) perl $(location crypto/ec/asm/x25519-x86_64.pl) elf $(location crypto/ec/x25519-x86_64.s);
CC=$(CC) perl $(location crypto/md5/asm/md5-x86_64.pl) elf $(location crypto/md5/md5-x86_64.s);
CC=$(CC) perl $(location crypto/modes/asm/aesni-gcm-x86_64.pl) elf $(location crypto/modes/aesni-gcm-x86_64.s);
CC=$(CC) perl $(location crypto/modes/asm/ghash-x86_64.pl) elf $(location crypto/modes/ghash-x86_64.s);
CC=$(CC) perl $(location crypto/poly1305/asm/poly1305-x86_64.pl) elf $(location crypto/poly1305/poly1305-x86_64.s);
CC=$(CC) perl $(location crypto/rc4/asm/rc4-md5-x86_64.pl) elf $(location crypto/rc4/rc4-md5-x86_64.s);
CC=$(CC) perl $(location crypto/rc4/asm/rc4-x86_64.pl) elf $(location crypto/rc4/rc4-x86_64.s);
CC=$(CC) perl $(location crypto/sha/asm/keccak1600-x86_64.pl) elf $(location crypto/sha/keccak1600-x86_64.s);
CC=$(CC) perl $(location crypto/sha/asm/sha1-mb-x86_64.pl) elf $(location crypto/sha/sha1-mb-x86_64.s);
CC=$(CC) perl $(location crypto/sha/asm/sha1-x86_64.pl) elf $(location crypto/sha/sha1-x86_64.s);
CC=$(CC) perl $(location crypto/sha/asm/sha256-mb-x86_64.pl) elf $(location crypto/sha/sha256-mb-x86_64.s);
CC=$(CC) perl $(location crypto/sha/asm/sha512-x86_64.pl) elf $(location crypto/sha/sha256-x86_64.s);
CC=$(CC) perl $(location crypto/sha/asm/sha512-x86_64.pl) elf $(location crypto/sha/sha512-x86_64.s);
CC=$(CC) perl $(location crypto/whrlpool/asm/wp-x86_64.pl) elf $(location crypto/whrlpool/wp-x86_64.s);
CC=$(CC) perl $(location crypto/x86_64cpuid.pl) elf $(location crypto/x86_64cpuid.s);
CC=$(CC) perl $(location engines/asm/e_padlock-x86_64.pl) elf $(location engines/e_padlock-x86_64.s);
"""
